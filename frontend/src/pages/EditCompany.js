...
function EditCompany() {
  ...
  return (
    <div className="edit-company-container">
      ...
      <div className={`edit-card-wrapper ${isVisible ? 'fade-in-up' : ''}`}>
        <div className="edit-card">
          ...
          <div className="edit-header">
            ...
            <h2 className="edit-title">
              <span className="gradient-text-edit">Edit Company</span>
            </h2>
      ...
      <style jsx>{`
        * {
        ...
        .orb2 {
          width: 500px;
          height: 500px;
          background: radial-gradient(circle, rgba(245, 158, 11, 0.6), rgba(245, 158, 11, 0.3));
          bottom: -250px;
          right: -250px;
          animation-delay: -5s;
        }
        ...
        .gradient-text-edit {
          background: linear-gradient(135deg, #fff, #fbbf24, #fcd34d);
        ...
        .btn-update:hover:not(:disabled) .btn-arrow {
